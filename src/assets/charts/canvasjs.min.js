...
/*jshint ignore:start*/
(function() {
    function na(h, n) { h.prototype = db(n.prototype);
    ...
    function Z(h, n) { var E = !1;
        0 > h && (E = !0, h *= -1);
        h = "" + h; for (n = n ? n : 1; h.length < n;) h = "0" + h; return E ? "-" + h : h }

    function Ha(h) { if (!h) return h;
        h = h.replace(/^\s\s*/, ""); for (var n = /\s/, E = h.length; n.test(h.charAt(--E));); return h.slice(0, E + 1) }
    ...
    function O(h) { var n = ((h & 16711680) >> 16).toString(16),
            E = ((h & 65280) >> 8).toString(16);
        h = ((h & 255) >> 0).toString(16);
        n = 2 > n.length ? "0" + n : n;
        E = 2 > E.length ? "0" + E : E;
        h = 2 > h.length ? "0" + h : h; return "#" + n + E + h }
    ...
    function K(h, n, E, w, sa) { w = w || [];
        sa = r(sa) ? gb ? { passive: !1, capture: !1 } : !1 : sa;
        w.push([h, n, E, sa]); return h.addEventListener ? (h.addEventListener(n, E, sa), E) : h.attachEvent ? (w = function(n) { n = n || window.event;
            n.preventDefault = n.preventDefault || function() { n.returnValue = !1 };
            n.stopPropagation = n.stopPropagation || function() { n.cancelBubble = !0 };
            E.call(h, n) }, h.attachEvent("on" + n, w), w) : !1 }
    ...
    function hb(h) {
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ...
            }), h._dropdownMenu.style.display = "none", h._toolBar.appendChild(h._dropdownMenu), K(h._dropdownMenu, "blur", function() { ua(h._dropdownMenu);
                h._dropDownCloseTime = new Date }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, { padding: "12px 8px 12px 8px" }), E.innerHTML = h._cultureInfo.printText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E),
            K(E, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), K(E, "mousemove", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(E, "click", function() { h.print();
                ua(h._dropdownMenu) }, h.allDOMEventHandlers, !0), E = document.createElement("div"), S(E, { padding: "12px 8px 12px 8px" }),
            E.innerHTML = h._cultureInfo.saveJPGText, E.style.backgroundColor = h.toolbar.itemBackgroundColor, E.style.color = h.toolbar.fontColor, h._dropdownMenu.appendChild(E), K(E, "touchstart", function(h) { n = !0 }, h.allDOMEventHandlers), K(E, "mousemove", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColorOnHover, this.style.color = h.toolbar.fontColorOnHover) }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) },
                h.allDOMEventHandlers, !0), K(E, "click", function() { h.exportChart({ format: "jpeg", fileName: h.exportFileName });
            ...
            }, h.allDOMEventHandlers, !0), K(E, "mouseout", function() { n || (this.style.backgroundColor = h.toolbar.itemBackgroundColor, this.style.color = h.toolbar.fontColor) }, h.allDOMEventHandlers, !0), K(E, "click", function() { h.exportChart({ format: "png", fileName: h.exportFileName });
                ua(h._dropdownMenu) }, h.allDOMEventHandlers, !0))
    }
    ...
    function ra(h, n, E) { Ia && (this.canvasCount |= 0, window.console.log(++this.canvasCount)); var r = document.createElement("canvas");
    ...
    function Ta(h, n, E, r, w) { if (null === h || "undefined" === typeof h) return "undefined" === typeof E ? n : E;
        h = parseFloat(h.toString()) * (0 <= h.toString().indexOf("%") ? n / 100 : 1); "undefined" !== typeof r && (h = Math.min(r, h), "undefined" !== typeof w && (h = Math.max(w, h))); return !isNaN(h) && h <= n && 0 <= h ? h : "undefined" === typeof E ? n : E }
    ...
    function Fa(h, n, r, w, v) { "undefined" === typeof v && (v = 0);
        this._padding = v;
        this._x1 = h;
        this._y1 = n;
        this._x2 = r;
    ...
    function ka(h, n) { ka.base.constructor.call(this, "TextBlock", null, n, null, null);
        this.ctx = h;
        this._isDirty = !0;
    ...
    var gb = function() { var h = !1; try { var n = Object.defineProperty && Object.defineProperty({}, "passive", { get: function() { h = !0; return !1 } });
                window.addEventListener && (window.addEventListener("test", null, n), window.removeEventListener("test", null, n)) } catch (r) { h = !1 } return h }(),
        Za = {},
        wa = null,
        lb = function() {
        ...
        fa = function(h, n, r) {
            ...
            for (var N = 0; B && N < B.length; N++)
                if (n =
                    ...
                    else if ("\u2030" === n) { A *= 1E3; continue } else if ("," === n[0] && "." === n[n.length - 1]) { A /= Math.pow(1E3, n.length - 1);
                        J = N + n.length - 1; continue } else "E" !== n[0] && "e" !== n[0] || "0" !== n[n.length - 1] || (S = !0);
            ...
            for (S = B = N = K = J = 0; 0 < P.length;)
                if (n = P.pop(), "#" === n || "0" === n)
                    if (J++, J === O) { var $ = A,
                            A = []; if ("0" === n)
                            for (n = O - K - ($ ? $.length : 0); 0 < n;) $.unshift("0"), n--; for (; 0 < $.length;) r = $.pop() + r, S++, 0 === S % B && (N === I && 0 < $.length) && (r = U + r) } else 0 < A.length ? (r = A.pop() + r, K++, S++) : "0" === n && (r = "0" + r, K++, S++), 0 === S % B && (N === I && 0 < A.length) && (r = U + r);
        ...
        Pa = function(h) { var n = 0,
                r = 0;
            h = h || window.event;
            h.offsetX || 0 === h.offsetX ? (n = h.offsetX, r = h.offsetY) : h.layerX || 0 == h.layerX ? (n = h.layerX, r = h.layerY) : (n = h.pageX - h.target.offsetLeft, r = h.pageY - h.target.offsetTop); return { x: n, y: r } },
        ab = !0,
    ...
    X.prototype.setOptions = function(h, n) { if (oa[this._defaultsKey]) { var r = oa[this._defaultsKey],
                w; for (w in r) "publicProperties" !== w && r.hasOwnProperty(w) && (this[w] = h && w in h ? h[w] : n && w in n ? n[w] : r[w]) } else Ia && window.console && console.log("defaults not set") };
    ...
    X.prototype.createUserOptions = function(h) {
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder &&
                ...
                n[r] = this.options } else this.options = "undefined" === typeof h ? {} : h, h = this.parent.options, this.optionsName ? n = this.optionsName : (n = this._defaultsKey) && 0 !== n.length ? (r = n.charAt(0).toLowerCase(), 1 < n.length && (r = r.concat(n.slice(1))),
                n = r) : n = void 0, h[n] = this.options
    };
    X.prototype.remove = function(h) { h = "undefined" === typeof h ? !0 : h; if (this.isOptionsInArray) { var n = this.parent.options[this.optionsName];
            Ea(n); var r = n.indexOf(this.options);
            0 <= r && n.splice(r, 1) } else delete this.parent.options[this.optionsName];
    ...
    X.prototype.trackChanges = function(h) { if (!this.sessionVariables) throw "Session Variable Store not set";
    ...
    X.prototype.removeEventListener = function(h, n) { if (h && n && this._eventListeners[h])
    ...
    ka.prototype.measureText = function() { this._lineHeight = Ya(this.fontFamily, this.fontSize, this.fontWeight); if (null === this.maxWidth) throw "Please set maxWidth and height for TextBlock";
    ...
    Va.prototype.get = function(h, n) { var r = null;
        0 < this.pool.length ? (r = this.pool.pop(), Na(r, h, n)) : r = ra(h, n); return r };
    ...
    v = Qa.Chart = function() {
        ...
        function n(a, d, c) {
            ...
            (this.container.innerHTML = "", d = a = 0, a = this.options.width ? this.width : 0 < this.container.clientWidth ? this.container.clientWidth : this.width, d = this.options.height ? this.height : 0 < this.container.clientHeight ? this.container.clientHeight : this.height, this.width = a, this.height = d, this.x1 = this.y1 = 0, this.x2 = this.width, this.y2 = this.height, this.selectedColorSet = "undefined" !== typeof za[this.colorSet] ? za[this.colorSet] : za.colorSet1, this._canvasJSContainer = document.createElement("div"), this._canvasJSContainer.setAttribute("class",
                ...
                "none", this.canvas.style.userSelect = "none", this.canvas.getContext && (this._canvasJSContainer.appendChild(this.canvas), this.ctx = this.canvas.getContext("2d"), this.ctx.textBaseline = "top", Da(this.ctx), this._preRenderCtx = this._preRenderCanvas.getContext("2d"), this._preRenderCtx.textBaseline = "top", Da(this._preRenderCtx), w ? this.plotArea.ctx = this.ctx : (this.plotArea.canvas = ra(a, d), this.plotArea.canvas.style.position = "absolute", this.plotArea.canvas.setAttribute("class", "plotAreaCanvas"), this._canvasJSContainer.appendChild(this.plotArea.canvas),
                    ...
                    ua(b._dropdownMenu) }, this.allDOMEventHandlers), K(this.overlaidCanvas, "mouseout", function(a) { b._mouseEventHandler(a) }, this.allDOMEventHandlers), K(this.overlaidCanvas, window.navigator.msPointerEnabled ?
        ...
        function Y(a, d, c) { Y.base.constructor.call(this, "Crosshair", "crosshair", d, null, c);
            this.chart = a;
            this.ctx = this.chart.ctx;
            this.axis = c;
        ...
        n.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton) S(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }), pa(this, this._zoomButton, "zoom");
                    ...
                    K(this._zoomButton, "click", function() { a.zoomEnabled ? (a.zoomEnabled = !1, a.panEnabled = !0, pa(a, a._zoomButton, "zoom")) : (a.zoomEnabled = !0, a.panEnabled = !1, pa(a, a._zoomButton, "pan"));
        ...
        n.prototype._updateSize = function() {
            ...
            if (this.canvas.width !== d * ia || this.canvas.height !== c * ia) { for (var b = 0; b < a.length; b++) Na(a[b], d, c);
            ...
            if (this.height) {
                ...
                if (0 < c.length) m.disableToolTip = !0, m._animator.animate(200, m.animationDuration, function(a) {
                    ...
                    m.dispatchEvent("dataAnimationIterationEnd", { chart: m })
                        ...
                        for (var e = m.plotInfo.plotTypes[a], d = 0; d < e.plotUnits.length; d++) { var f = e.plotUnits[d];
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    for (D = 0; D < t.dataPoints.length; D++) {
                        ...
                        if (0 <
                            D) { if (a.axisX.logarithmic) { var s = b / t.dataPoints[D - 1].x;
                                1 > s && (s = 1 / s);
                                c.minDiff > s && 1 !== s && (c.minDiff = s) } else s = b - t.dataPoints[D - 1].x, 0 > s && (s *= -1), c.minDiff > s && 0 !== s && (c.minDiff = s);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [],
                    ...
                    for (q = 0; q < p.dataPoints.length; q++) {
                        ...
                        b < c.min && (c.min = b);
                        b > c.max && (c.max = b);
                        if (0 < q) { if (a.axisX.logarithmic) { var n = b / p.dataPoints[q - 1].x;
                                1 > n && (n = 1 / n);
                                c.minDiff > n && 1 !== n && (c.minDiff = n) } else n = b - p.dataPoints[q - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n);
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, D = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        b > c.max && (c.max = b);
                        if (0 < p) {
                            if (a.axisX.logarithmic) { var u = b / m.dataPoints[p - 1].x;
                                1 > u && (u = 1 / u);
                                c.minDiff > u && 1 !== u && (c.minDiff = u) } else u = b - m.dataPoints[p -
        ...
        n.prototype.calculateAutoBreaks = function() {
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c =
                            b.min, d = b.max, g = b._dataRanges, f, k = 0, l = 0; l < a.dataSeriesIndexes.length; l++) { var m = e.data[a.dataSeriesIndexes[l]]; if (!(4 > m.dataPoints.length))
            ...
            for (var b, e = this, f = !1, l = 0; l < this._axes.length; l++)
                if (this._axes[l].scaleBreaks && this._axes[l].scaleBreaks.autoCalculate &&
                    1 <= this._axes[l].scaleBreaks.maxNumberOfAutoBreaks) { f = !0;
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYPositiveSums) { var q = this._axes[l].dataInfo.dataPointYPositiveSums;
                            m = k; for (t in q)
                                if (q.hasOwnProperty(t) && !isNaN(t) && (p = q[t], !r(p))) { var g = Math.floor((p - D) / b);
                                    p < m[g].min && (m[g].min = p);
                                    p > m[g].max && (m[g].max = p) }
                        ...
                        for (t = 0; t < k.length - 1; t++)
                            if (m = k[t].max, isFinite(m))
                                for (; t < k.length - 1;)
                                    if (D = k[t + 1].min, isFinite(D)) { p = D - m;
                                        p > b && f.push({ diff: p, start: m, end: D }); break } else t++;
        ...
        n.prototype.renderLine = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], l, t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var m = k.dataPoints,
                        p = "solid";
                    if (c.setLineDash) { var q = J(k.nullDataLineDashType, k.lineThickness),
                            p = k.lineDashType,
        ...
        n.prototype.renderSpline = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    var m = k.dataPoints,
                        p = "solid";
                    if (b.setLineDash) { var q = J(k.nullDataLineDashType, k.lineThickness),
                            p = k.lineDashType,
                            g = J(p, k.lineThickness);
                        b.setLineDash(g) }
                    var s = k.id;
                        ...
                        for (n = !1, r = 0; r < m.length; r++)
                            if (u = m[r].getTime ? m[r].x.getTime() : m[r].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !n)))
                                if ("number" !== typeof m[r].y) 0 < r && !n && (k.connectNullData ? b.setLineDash && (0 < x.length && (k.options.nullDataLineDashType || !m[r - 1].lineDashType)) && (x[x.length -
                                    ...
                                    if (0 !== m[r].markerSize && (0 < m[r].markerSize || 0 < k.markerSize)) { var G = k.getMarkerProperties(r, u, n, b);
                                        l.push(G);
                                        z = O(z);
                                        w && l.push({ x: u, y: n, ctx: e, type: G.type, size: G.size, color: z, borderColor: z, borderThickness: G.borderThickness }) }(m[r].indexLabel || k.indexLabel || m[r].indexLabelFormatter || k.indexLabelFormatter) && this._indexLabels.push({
                                        chartType: "spline",
                                        dataPoint: m[r],
                                        dataSeries: k,
                                        point: { x: u, y: n },
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) &&
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (p = a.axisY.convertValueToPixel(t[b]), z = "undefined" !== typeof f[b] ? f[b] : q, f[b] = p);
                                        ...
                                        l[b] : q, l[b] = z;
                                    else if (p = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) { var G = "undefined" !== typeof f[b] ? f[b] : 0;
                                        p -= G;
                                        z = q - G;
                                        f[b] = G + (z - p) } else G = l[b] ? l[b] : 0, z = p + G, p = q + G, l[b] = G + (z - p);
                    ...
                    if (0 < u.length)
                        for (var n = 5 < s && r.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                ...
                                else if (p = a.axisY.convertValueToPixel(p), 0 <= u[k].y) { var G = "undefined" !== typeof f[b] ? f[b] : 0;
                                    p -= G;
                                    z = q - G;
                                    a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y1 - p) && (p = e.y1);
                                    f[b] = G + (z - p) } else G = "undefined" !== typeof l[b] ? l[b] : 0, z = p + G, p = q + G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.y2 - z) && (z = e.y2), l[b] = G + (z - p);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                else if (m = a.axisY.convertValueToPixel(u[k].y), 0 <= u[k].y) { var G = f[b] ? f[b] : 0;
                                    z = q + G;
                                    m += G;
                                    f[b] = G + (m - z) } else G = l[b] ? l[b] : 0, z = m - G, m = q - G, l[b] = G + (m - z);
                                b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
                        ...
                        if (0 < u.length) {
                            ...
                            for (k = 0; k < u.length; k++)
                                if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin ||
                                    ...
                                    p = p - a.plotType.plotUnits.length * s / 2 + a.index * s << 0;
                                    var z = p + s << 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) { t[b] = x + (t[b] ? t[b] : 0); if (0 >= t[b]) continue;
                                        x = f[b] ? f[b] : q;
                                        f[b] = m = a.axisY.convertValueToPixel(t[b]) } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) D[b] =
                                        x + (D[b] ? D[b] : 0), m = l[b] ? l[b] : q, l[b] = x = a.axisY.convertValueToPixel(D[b]);
                                    else if (m = a.axisY.convertValueToPixel(x), 0 <= u[k].y) { var G = f[b] ? f[b] : 0;
                                        x = q + G;
                                        m += G;
                                        a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x2 - m) && (m = e.x2);
                                        f[b] = G + (m - x) } else G = l[b] ? l[b] : 0, x = m - G, m = q - G, a.dataSeriesIndexes.length - 1 === g && 1 >= Math.abs(e.x1 - x) && (x = e.x1), l[b] = G + (m - x);
                                    b = u[k].color ? u[k].color : r._colorSet[k % r._colorSet.length];
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (0 < s.length) {
                        ...
                        c = "solid";
                        if (f.setLineDash) { var M = J(g.nullDataLineDashType, g.lineThickness);
                            c = g.lineDashType; var T = J(c, g.lineThickness);
                            f.setLineDash(T) }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var h = 0; h < a.dataSeriesIndexes.length; h++) {
                    ...
                    if (0 < p.length) {
                        ...
                        var C = "solid";
                        if (b.setLineDash) { var A = J(m.nullDataLineDashType, m.lineThickness),
                                C = m.lineDashType,
                        ...
                        for (s = !1; q < p.length; q++)
                            if (g = p[q].x.getTime ? p[q].x.getTime() : p[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !s)))
                                if ("number" !== typeof p[q].y) 0 < q && !s && (m.connectNullData ? b.setLineDash && (0 < y.length && (m.options.nullDataLineDashType ||
                                    ...
                                    if (0 !== p[q].markerSize && (0 < p[q].markerSize || 0 < m.markerSize)) { var T = m.getMarkerProperties(q, g, s, b);
                                        l.push(T);
                                        M = O(M);
                                        w && l.push({ x: g, y: s, ctx: e, type: T.type, size: T.size, color: M, borderColor: M, borderThickness: T.borderThickness }) }(p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
        ...
        n.prototype.renderStackedArea = function(a) {
            function d() {
                if (!(1 > k.length)) {
                    for (0 < C.lineThickness && b.stroke(); 0 < k.length;) { var a = k.pop();
                        b.lineTo(a.x, a.y);
                        w && n.lineTo(a.x, a.y) }
                    b.closePath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    ...
                    if (0 < m.length) {
                        ...
                        x = "solid";
                        if (b.setLineDash) { var T = J(C.nullDataLineDashType, C.lineThickness);
                            x = C.lineDashType; var E = J(x, C.lineThickness);
                            b.setLineDash(E) }
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y) C.connectNullData || (aa || y) || d(), aa = !0;
                                    ...
                                    var ma =
                                        h[f] ? h[f] : 0;
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ha.y + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ha.y), s -= ma;
                                    k.push({ x: g, y: r - ma });
                                    h[f] = r - s;
                                    ...
                                    if (0 <= C.dataPointIndexes[f]) { var B = C.dataPointIds[C.dataPointIndexes[f]];
        ...
        n.prototype.renderStackedArea100 = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                w && (x.beginPath(), x.rect(l.x1, l.y1, l.width,
                    l.height), x.clip());
                for (var e = [], z = 0; z < a.dataSeriesIndexes.length; z++) { var G = a.dataSeriesIndexes[z],
                        C = this.data[G],
                        v = C.dataPoints;
                    C.dataPointIndexes = []; for (q = 0; q < v.length; q++) G = v[q].x.getTime ? v[q].x.getTime() : v[q].x, C.dataPointIndexes[G] = q, e[G] || (m.push(G), e[G] = !0);
                    m.sort(Ra) }
                for (z = 0; z < a.dataSeriesIndexes.length; z++) {
                    G = a.dataSeriesIndexes[z];
                    C = this.data[G];
                    ...
                    if (0 < m.length) {
                        ...
                        u = "solid";
                        if (b.setLineDash) { var T = J(C.nullDataLineDashType, C.lineThickness);
                            u = C.lineDashType; var E = J(u, C.lineThickness);
                            b.setLineDash(E) }
                        for (var aa = !0, q = 0; q < m.length; q++) {
                            var f = m[q],
                                ha = null,
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !aa)))
                                if ("number" !== typeof ha.y) C.connectNullData ||
                                    ...
                                    if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length) { p[f] = ma + (p[f] ? p[f] : 0); if (0 >= p[f] && a.axisY.logarithmic) continue;
                                        s = a.axisY.convertValueToPixel(p[f]) } else s = a.axisY.convertValueToPixel(ma), s -= B;
                                    k.push({ x: g, y: y - B });
                                    h[f] = y - s;
                                    ...
                                    if (0 <= C.dataPointIndexes[f]) { var F = C.dataPointIds[C.dataPointIndexes[f]];
            ...
            function d() {
                if (y) {
                    ...
                    if (0 < m.lineThickness) { b.beginPath();
                        b.moveTo(a.x, a.y2); for (c = 0; c < h.length; c++) a = h[c], b.lineTo(a.x, a.y2);
                        b.moveTo(h[0].x, h[0].y1); for (c = 0; c < h.length; c++) a = h[c], b.lineTo(a.x, a.y1);
                        b.stroke() }
                    b.beginPath();
                    b.moveTo(s, r);
                    e.beginPath();
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < p.length) {
                        ...
                        b.lineWidth = m.lineThickness;
                        var C = "solid";
                        if (b.setLineDash) { var B = J(m.nullDataLineDashType, m.lineThickness),
                                C = m.lineDashType,
                            ...
                            if (u = p[g].x.getTime ? p[g].x.getTime() : p[g].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !M)))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    if (0 !== p[g].markerSize && (0 < p[g].markerSize ||
                                            0 < m.markerSize)) { var T = m.getMarkerProperties(g, s, n, b);
                                        f.push(T); var ga = O(u);
            ...
            function d(a, c) {
                ...
                if (0 < d.length) {
                    if (0 < k.lineThickness) {
                        ...
                        for (var f = 0; f < d.length - 3; f += 3) { if (d[f].newStrokeStyle || d[f].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), d[f].newStrokeStyle && (b.strokeStyle = d[f].newStrokeStyle), d[f].newLineDashArray && b.setLineDash(d[f].newLineDashArray);
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        b.beginPath();
                        b.moveTo(d[0].x, d[0].y);
                        for (var g = f = 0; f < d.length - 3; f += 3, g++) { if (n[g].newStrokeStyle || n[g].newLineDashArray) b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), n[g].newStrokeStyle && (b.strokeStyle = n[g].newStrokeStyle), n[g].newLineDashArray && b.setLineDash(n[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y) }
                        d = v(n, 2);
                        b.moveTo(d[0].x, d[0].y);
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var x = 5 < q && n.bevelEnabled ? !0 : !1, z = !1, A = null, C = null, l = 0; l < v.length; l++)
                            if (v[l].getTime ? m = v[l].x.getTime() : m = v[l].x, "number" !== typeof v[l].y) { if (0 < l && !z && n.connectNullData) var B = n.options.nullDataLineDashType || !v[l - 1].lineDashType ? n.nullDataLineDashType : v[l - 1].lineDashType;
                                z = !0 } else {
        ...
        n.prototype.renderPie = function(a) {
                ...
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        if (h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u) { if (0 === a || g[c].midAngle > h.midAngle) c = e;
                            a++ } else if (h.midAngle > 3 * Math.PI / 2 - u && h.midAngle < 3 * Math.PI / 2 + u) { if (0 === b || g[d].midAngle > h.midAngle) d = e;
                            b++ }
            ...
            function l() {
                ...
                for (var c = a = 0, d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    ...
                    if ("inside" !== k.indexLabelPlacement) {
                        w = C * v;
                        for (a = 0; a < m.length; a++) { var h = g[a];
                        ...
                        for (var t, r, a = 0; a < m.length; a++) {
                            ...
                            if (null !== u) {
                                ...
                                var z = 0,
                                    z = b(t, r) -
                                    s;
                                if (0 > z) { for (var A = r = 0, G = 0; G < m.length; G++) G !== a && g[G].hemisphere === h.hemisphere && (g[G].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? r++ : A++);
                                    r = z / (r + A || 1) * A; var A = -1 * (z - r),
                                        J = G = 0; "right" === h.hemisphere ? (G = f(a, r), A = -1 * (z - G), J = f(u, A), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(a, -(A - J))) : (G = f(u, r), A = -1 * (z - G), J = f(a, A), +J.toFixed(y) < +A.toFixed(y) && +G.toFixed(y) <= +r.toFixed(y) && f(u, -(A - J))) }
                            }
                        }
                    } else
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== z) {
                    ...
                    this.pieDoughnutClickHandler = function(a) { n.isAnimating || !r(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && n._animator.animate(0, 500, function(a) { c(a);
                            h();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration :
                        ...
                        function(a) {
                            ...
                            b.fillStyle = n.backgroundColor;
                            b.fillRect(q.x1, q.y1, q.width, q.height);
                            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) { var d = 0 === c ? g[c].startAngle : e,
                                    e = d + (g[c].endAngle - g[c].startAngle),
                                    f = !1;
                                e > b && (e = b, f = !0); var l = m[c].color ? m[c].color : k._colorSet[c % k._colorSet.length];
                                e > d && W(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius); if (f) break }
                            h();
                            n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
        ...
        n.prototype.renderFunnel = function(a) {
            function d() {
                for (var a = 0, b = [], c = 0; c < y.length; c++) { if ("undefined" === typeof y[c].y) return -1;
            ...
            function l() {
                    ...
                    for (l = Q.length - 1; 0 < l; l--)
                        if (!H[l].isDirty) {
                            ...
                            if (H[l].textBlock.y < H[e].textBlock.y + H[e].height) {
                                ...
                                f = l;
                                for (k =
                                    0; H[f].textBlock.y < H[e].textBlock.y + H[e].height + ea;) { a = a || H[f].textBlock.y + H[f].height;
                                    k += H[f].height;
                                    k += ea;
                                    f = e; if (0 >= f) { f = 0;
                                        k += H[f].height; break }
                ...
                for (var d, e, f, g, k, l, m = 1, n = 0; n < 2 * m; n++) { for (var s = H.length - 1; 0 <= s && !(0 <= p(s) && p(s), f = H[s], g = f.textBlock, l = (k = q(s) < Q.length ? H[q(s)] : null) ? k.textBlock : null, d = +f.height.toFixed(6), e = +g.y.toFixed(6), !f.isDirty && (k && e + d + ea > +l.y.toFixed(6)) && (d = g.y + d + ea - l.y, e = a(s, -d), e < d && (0 < e && (d -= e), e = a(q(s), d), e != d))); s--);
                    b() }
            }
            ...
            function n(a,
                ...
                if (0 === W.length) l = ia;
                else { e = z * (1 != W.length || 0 != W[0] && W[0] != Q.length - 1 ? 2 : 1) / k(); for (var q = 0; q < Q.length; q++) { if (1 == W.length && 0 == W[0]) { if (0 === q) { l.push(ia[q]);
                                d = h; continue } } else 0 === q && (d = -1 * h);
                        l.push(ia[q] + d); if (0 <= W.indexOf(q) || q < Q.length && 0 <= W.indexOf(q + 1)) d += e } }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== y.length) {
                    ...
                    if (-1 !== T) {
                        ...
                        this.funnelPyramidClickHandler = function(a) { var b = -1; if (!ja && !A.isAnimating && (r(a.dataSeries.explodeOnClick) || a.dataSeries.explodeOnClick) && (b = u.reversed ? y.length - 1 - a.dataPointIndex : a.dataPointIndex, 0 <= b)) { a = b; if ("funnel" === u.type || "pyramid" === u.type) u.reversed ? y[y.length - 1 - a].exploded = y[y.length - 1 - a].exploded ? !1 : !0 : y[a].exploded = y[a].exploded ? !1 : !0;
                                n(A, b, 500) } };
                        return {
                            source: U,
                            dest: this.plotArea.ctx,
        ...
        n.prototype.exportChart = function(a) {
            ...
            if (b && d && c) {
                ...
                f.download = c;
                f.href = b;
                if ("undefined" !== typeof Blob && new Blob) { for (var l = b.replace(/^data:[a-z\/]*;base64,/, ""), l = atob(l), h = new ArrayBuffer(l.length), h = new Uint8Array(h), n = 0; n < l.length; n++) h[n] = l.charCodeAt(n);
                    d = new Blob([h.buffer], { type: "image/" + d }); try { window.navigator.msSaveBlob(d, c), e = !0 } catch (k) { f.dataset.downloadurl = [a, f.download, f.href].join(":"), f.href = window.URL.createObjectURL(d) } }
                if (!e) try {
        ...
        n.prototype.getPercentAndTotal = function(a, d) { var c = null,
                b = null,
                e = c = null; if (0 <= a.type.indexOf("stacked")) b = 0, c = d.x.getTime ? d.x.getTime() : d.x, c in a.plotUnit.yTotals && (b = a.plotUnit.yTotals[c], c = a.plotUnit.yAbsTotals[c], e = isNaN(d.y) ? 0 : 0 === c ? 0 : 100 * (d.y / c));
                ...
                e = isNaN(d.y) ? 0 : 100 * (d.y / b) } return { percent: e, total: b } };
        ...
        A.prototype.createExtraLabelsForLog = function(a) {
            ...
            if (!(5 < a)) {
                ...
                if (Math.log(this.range) /
                    Math.log(d / this.viewportMinimum) < this.noTicks - 1) { for (var c = A.getNiceNumber((d - this.viewportMinimum) / Math.min(Math.max(2, this.noTicks - this.logLabelValues.length), 3), !0), b = Math.ceil(this.viewportMinimum / c) * c; b < d; b += c) b < this.viewportMinimum || this.logLabelValues.push(b);
        ...
        A.prototype.createLabelsAndCalculateWidth = function() {
            ...
            if ("left" === this._position || "right" === this._position) {
                ...
                if ("inside" != this.labelPlacement || "inside" === this.labelPlacement && 0 < this._index)
                    for (d = 0; d < this._labels.length; d++) { var b = this._labels[d].textBlock,
                            e = b.measureText(),
                            f = 0,
        ...
        A.prototype.setViewPortRange = function(a, d) { this.sessionVariables.newViewportMinimum = this.viewportMinimum = Math.min(a, d);
        ...
        A.getNiceNumber = function(a, d) { var c = Math.floor(Math.log(a) / Math.LN10),
                b = a / Math.pow(10, c),
        ...
        na(V, X);
        na(da, X);
        da.prototype.createUserOptions = function(a) { if ("undefined" !== typeof a || this.options._isPlaceholder) { var d = 0;
            ...
            if (0 !==
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    ...
                    for (q = 0; q < m; q++) this.ctx.bezierCurveTo(r + f * a, k - a, r + f * a, k - 2 * a, r, k - 3 * a), k -= 3 * a, f *= -1
                        ...
                        k = e + a;
                        r = b + a;
                        m = (n - k) / a / 2; for (q = 0; q < m; q++) this.ctx.lineTo(r, k), r += 2 * f * a, k += 2 * a, f *= -1;
                        this.ctx.lineTo(r, k);
                        r += h - b; for (q = 0; q < m + 1; q++) this.ctx.lineTo(r, k), r += 2 * f * a, k -= 2 * a, f *= -1;
                    ...
                    k = e - a;
                    r = b + a;
                    m = (h - r) / a / 2; for (q = 0; q < m; q++) this.ctx.lineTo(r, k), k += 2 * f * a, r += 2 * a, f *= -1;
                    this.ctx.lineTo(r, k);
                    k += n - e; for (q = 0; q < m + 1; q++) this.ctx.lineTo(r, k), k += 2 * f * a, r -= 2 * a, f *= -1;
        ...
        Y.prototype.hide = function() { this.chart.resetOverlayedCanvas();
            this.chart.renderCrosshairs(this.parent);
            this._hidden = !0 };
        ...
        ea.prototype.reset = function() { this.lastObjectId = 0;
            this.objectMap = [];
            this.rectangularRegionEventSubscriptions = [];
            this.previousDataPointEventObject = null;
            this.eventObjects = [];
        ...
        ja.prototype.cancelAllAnimations = function() { this.animations = [];
